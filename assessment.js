...
function getValueOfProperty (obj,juston){
	return obj.name;
}
...
*/
function outside (num1,num2,num3){
	if(num1 >= 80 && num2 >= 40){
		return "I'm all sweat";
	}else if (num1 <= 40 && num3 >= 60){
		return "I have icecicles";
	}else if (num1 >= 80 && num2 <= 40 && num3 <= 20){
		return "I'm literally in the desert";
	}else if (num1 >= 80 || num2 >= 50 || num3 >= 50){
